<?php
/*
Plugin Name: Media Share  - drop down menu
Plugin URI: 
Description: Media social icon with drop down menu
Version: 0.1
Author: Sanauna
Author URI: 
License: GPL2
...
class active_share {
	...
	function ass_loadjs(){
		DEFINE('get_plugin_directory_uri', get_bloginfo('wpurl') . '/wp-content/plugins/socialmedia/');
		$options = get_option('as_options');
